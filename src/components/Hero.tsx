        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                From repairs to renovations, we handle all your home improvement needs with expertise and care. Quality work, fair prices, guaranteed results.
              </motion.p>
            </div>
            ...
            >
              {features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2 bg-white/70 backdrop-blur-sm rounded-full px-4 py-2">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full font-semibold text-lg hover:border-blue-600 hover:text-blue-600 transition-colors duration-300"
              >
                View Services
              </motion.button>
            </motion.div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 shadow-2xl">
              <div className="bg-white rounded-2xl p-8 space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">Book your service in just a few clicks</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-gray-700">Get quality work done</span>
                  </div>
                </div>
              </div>
            </div>
