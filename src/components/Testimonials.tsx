...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      location: 'Westside',
      rating: 5,
      text: 'HandyPro transformed my bathroom! The plumbing work was done perfectly, and they even gave me tips for maintenance. Great communication throughout the project.',
        ...
        >
          <div className="inline-flex items-center space-x-4 bg-white rounded-full px-8 py-4 shadow-lg">
            ...
            <div className="text-gray-700">
              <span className="font-bold text-gray-900">4.9/5</span> average rating from 200+ reviews
            </div>
          </div>
        </motion.div>
      </div>
